    ...
    return (
        <div className="flex flex-col w-[80%] md:w-[273px] h-[372px] gap-2">
            ...
            <div className="bg-primary-400 h-[160px] rounded-[12px] p-2 flex flex-col items-center justify-between">
                <h5>{name}</h5>
                <button className="bg-primary-600 w-full rounded-[4px] h-[35px] flex justify-center items-center text-background cursor-pointer"><Link href={id}>بخوانید</Link></button>
            </div>
        </div>
    )
}
