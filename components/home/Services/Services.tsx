    ...
    return (
        <div className="flex flex-col gap-8 lg:gap-12 px-4 lg:px-0">
            <div className="flex justify-center">
                <ServiceBox icon={services.web.icon} title={services.web.title} description={services.web.description} state={true} />
            </div>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-8 lg:gap-12 flex-wrap">
                <div className="w-full md:w-[45%] max-w-[600px]">
                    <ServiceBox icon={services.systems.icon} title={services.systems.title} description={services.systems.description} state={false} />
                </div>
                <div className="w-full md:w-[45%] max-w-[600px]">
                    <ServiceBox icon={services.mobile.icon} title={services.mobile.title} description={services.mobile.description} state={false} />
                </div>
            </div>

            <div className="flex justify-center">
                <ServiceBox icon={services.update.icon} title={services.update.title} description={services.update.description} state={true} />
            </div>
        </div>
    )
}
